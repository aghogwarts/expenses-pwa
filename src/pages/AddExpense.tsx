  ...
  return (
    <div className="page container">
      <div style={{
        ...
        fontWeight: 500, letterSpacing: '-0.02em', marginBottom: '1.5rem',
      }}>
        paisa<span style={{ color: 'var(--accent)' }}>.</span>
        <span style={{ fontSize: 11, color: 'var(--muted)', marginLeft: 10 }}>new entry</span>
      </div>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
        <div>
          ...
          <div style={{
            ...
            <span style={{ color: 'var(--subtle)', fontSize: 18, fontFamily: 'var(--font-mono)' }}>₹</span>
            <input
              type="number"
              inputMode="decimal"
              placeholder="0"
              ...
              style={{
                ...
                fontSize: 28, fontWeight: 500, color: 'var(--accent)',
        ...
        <button
          ...
          disabled={loading}
          style={{ height: 48, fontSize: 13, fontFamily: 'var(--font-mono)', letterSpacing: '0.08em' }}
        >
